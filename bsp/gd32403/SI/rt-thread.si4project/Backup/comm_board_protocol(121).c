...
static rs485_tx_t *pl_rs485_tx[ENUM_COMM_INDEX_MAX];
static rs485_rx_t *pl_rs485_rx[ENUM_COMM_INDEX_MAX];
static uint8_t *pl_tx_buf[ENUM_COMM_INDEX_MAX];
static uint8_t *pl_rx_buf[ENUM_COMM_INDEX_MAX];
static uint8_t *pl_DMA_buf[ENUM_COMM_INDEX_MAX];
...
static unsigned int sl_slave_usart_reenable_count[ENUM_COMM_INDEX_MAX];
...
static unsigned char slave_rs485_changed_bms_index_from_comm(unsigned char bms_index);
...
{SLAVE_RS485_CMD_DEV_VERSION, slave_rs485_cmd_get_dev_version},
{SLAVE_RS485_CMD_UPDATE_START, slave_rs485_cmd_update_start},
{SLAVE_RS485_CMD_UPDATE_EXCHANGE, slave_rs485_cmd_update_exchange},
{SLAVE_RS485_CMD_UPDATE_DONE, slave_rs485_cmd_update_done},
{SLAVE_RS485_CMD_CFG, slave_rs485_cmd_cfg},
{SLAVE_RS485_CMD_READ_BAT_RECORD, slave_rs485_cmd_read_bat_record},
{SLAVE_RS485_CMD_BYPASS, slave_rs485_cmd_bypass},
{SLAVE_RS485_CMD_SN_SETTING, slave_rs485_cmd_set_SN},
{SLAVE_RS485_CMD_UNLOCK, slave_rs485_cmd_unlock},
{SLAVE_RS485_CMD_CHARGE_EN, slave_rs485_cmd_charge_en},
{SLAVE_RS485_CMD_CHECK_BAT, slave_rs485_cmd_check_bat},
//{SLAVE_RS485_CMD_CHECK_LOCK_PORT_CHG, slave_rs485_cmd_check_lock_port_chg},
{SLAVE_RS485_CMD_DISCHARGE_EN, slave_rs485_cmd_discharge_en},
{SLAVE_RS485_CMD_GET_BAT_RECORD_PARAM, slave_rs485_cmd_get_bat_record_param},
{SLAVE_RS485_CMD_FAN_EN, slave_rs485_cmd_fan_enable},
{SLAVE_RS485_CMD_FAN_DISABLE, slave_rs485_cmd_fan_disable},
{SLAVE_RS485_CMD_FAN_TEMP_SETTING, slave_rs485_cmd_fan_temp_setting},
{SLAVE_RS485_CMD_R_RUNING_PARAM, slave_rs485_cmd_read_runing_param},
{SLAVE_RS485_CMD_R_REAL_TIME_INFO, slave_rs485_cmd_read_real_time_info},
//下面三个命令，在版本是V30以后有效
{SLAVE_RS485_CMD_R_BAT_INFO, slave_rs485_cmd_read_BAT_info},

#ifndef CABINET_WARMOR_SUPPLY_BY_CHARGER
{SLAVE_RS485_CMD_R_BAT_INFO_WHEN_CRITICAL_ERR, slave_rs485_cmd_read_BAT_info_when_critical_err},
{SLAVE_RS485_CMD_R_BAT_INFO_WHEN_EVENT_TO_STOP_CHG, slave_rs485_cmd_read_BAT_info_when_even_to_stop},
#endif

{SLAVE_RS485_CMD_R_BAT_INFO_WHEN_DETECT_BAT_ERROR, slave_rs485_cmd_read_BAT_info_when_detect_bat_error},
{SLAVE_RS485_CMD_R_ADC_RAW_VALUE, slave_rs485_cmd_read_ADC_raw_value},

{SLAVE_RS485_CMD_CLEAR_PMS_ERROR_FLAG, slave_rs485_cmd_clear_pms_error_flag},
{SLAVE_RS485_CMD_PMS_RESET, slave_rs485_cmd_pms_reset},
#ifdef TEST_DETECT_BAT_ERROR_EN
{SLAVE_RS485_CMD_DETECT_BAT_ERROR, slave_rs485_cmd_detect_bat_error},
#endif

#ifdef EVENT_TO_STOP_CHARGING_ENABLE
{SLAVE_RS485_CMD_EVENT_TO_STOP_CHARGING_FLAG_BE_DISABLE_FLAG, slave_rs485_cmd_event_to_stop_charging_flag_be_disable_flag},
{SLAVE_RS485_CMD_EVENT_TO_STOP_CHARGING_FLAG_BE_DISABLE_FLAG_CLEAR, slave_rs485_cmd_event_to_stop_charging_flag_be_disable_flag_clear},
#endif

#ifdef CABINET_WARMOR_SUPPLY_BY_CHARGER
{SLAVE_RS485_CMD_CHARGER_WARMER_ENABLE, slave_rs485_cmd_charger_warmer_enable},
{SLAVE_RS485_CMD_HEATER_ONOFF, slave_rs485_cmd_charger_warmer_test_enable},
#endif

/////////////////////////////////////////////////////////////////////////////
#ifdef TEST_TEST_CONDITION_CREATE_ENABLE
{SLAVE_RS485_CMD_TEST_TEST, slave_rs485_cmd_test_test},
#endif
/////////////////////////////////////////////////////////////////////////////
#ifdef BAT_PMS_AUTHORITY_FUNCTION_EN
{SLAVE_RS485_CMD_PMS_BAT_AUTHORITY_ENABLE, slave_rs485_cmd_pms_bat_authority},
#endif

{SLAVE_RS485_CMD_READ_CHARGER_TEMP_VALUE, slave_rs485_cmd_read_charger_temp_value},

};



static unsigned short slave_rs485_calc_CRC(unsigned char *pl_data, unsigned short len)
{
...
static void slave_rs485_calc_TX_tail(void)
{
    unsigned short vl_crc;
 ...
 *   none
 ******************************************************************************/
 static rs485_run_state_t slave_rs485_run_state[ENUM_COMM_INDEX_MAX]={MASTER_RS485_RUN_TX, MASTER_RS485_RUN_TX};
/*
等到发送完成后是否需要重启。
...
bool slave_rs485_data_handler_new_protocol(void)
{
        ...
        slave_rs485_rx.rs485_rx_buf[(slave_rs485_rx.rs485_rx_indx-1)]==((uint8_t)(0xFF&(crc>>8))))
    {
        ...
        vl_hub_cmd.stl_cmd = slave_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_CMD+1];
        vl_hub_cmd.stl_dataL = slave_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_DATAL+1];
        vl_hub_cmd.stl_data = &slave_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_DATA_START+1];
...
bool slave_rs485_cmd_unlock(st_hub_cmd *pl_hub_cmd)
{
    ...
    if(//(gl_stepper_motor_param.dir == ENUM_SM_CLOSE_DIR)||
        ((!ELock_get_open_delay_cnt(ELock_bms_index_to_elock_index(vl_bms_index)))&&
        (gl_stepper_motor_param.sm_dir_step_period_counter == 0)&&
        (gl_stepper_motor_param.timer_cnt == 0)))
    {
        //masked for delay。延迟开门
        //ELock_open(ELock_bms_index_to_elock_index(vl_bms_index));
        ELock_open_with_delay(ELock_bms_index_to_elock_index(vl_bms_index));

        if(0 == gl_stepper_motor_param.sm_need_to_open)
            SM_stop();
        
        //设置打开电池锁的标志
        gl_stepper_motor_param.sm_need_to_open = 1;
        gl_stepper_motor_param.sm_dir_step_period_counter = SM_DIR_STEP_PERIOD_COUNTER_MAX;
        //超时设置
        gl_stepper_motor_param.time_out_cnt = SM_DIR_STEP_MOTOR_TIMEOUT_MAX;
        SM_elock_poll(0);
        
        pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[0] = slave_rs485_get_dev_addr();
        pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[1] = SLAVE_RS485_CMD_UNLOCK;
...
//当前询问的port口
static unsigned char slave_rs485_cmd_update_port;
...
//        sl_bat_poll_param.poll_interval_for_bms_update_cnt = BAT_POLL_BMS_UPDATE_DELAY_MAX;
    ...
    {
        if((FALSE == master_rs485_is_cmd_list_empty())
...
bool slave_rs485_cmd_bypass(st_hub_cmd *pl_hub_cmd)
{
    unsigned char vl_bms_index;
    //转变地址为实际板上的地址
    vl_bms_index = slave_rs485_changed_bms_index_from_comm(pl_hub_cmd->stl_data[1]);
    
    if(((pl_hub_cmd->stl_data[0]) == ENUM_UPDATE_TAR_BMS_BOARD)&&
        ((BMS_READONLY_DATA1_FLAG_BIT|BMS_READONLY_DATA2_FLAG_BIT)&
            Battery_get_reg_valid_flag(vl_bms_index)))
    {
        //缓存目前的端口号
        slave_rs485_cmd_update_port = pl_hub_cmd->stl_data[1];

        // 串口停止接收，只允许发送。在发送数据到电池后再允许接收。
        slave_rs485_usart_enable[ENUM_COMM_INDEX_COMM](ENUM_USART_TX_ENABLE);

        //同时设置超时定时器，再允许串口接收
        sl_slave_usart_reenable_count[ENUM_COMM_INDEX_COMM] = 2000; //设置超时时间为2秒

        //设置NFC命令
        gl_cmd_buf[vl_bms_index][ENUM_NFC_CMD_INDEX_BYPASS] = 1;

        //暂停间隔轮询60秒
        if(sl_bat_poll_param.poll_allways_en_delay_cnt < BAT_POLL_DELAY_MAX_BY_BYPASS_CMD)
        {
            sl_bat_poll_param.poll_allways_en_delay_cnt = BAT_POLL_DELAY_MAX_BY_BYPASS_CMD;
        }
...
void slave_rs485_cmd_bypass_cnf(unsigned char *data, unsigned int data_len)
{
    //unsigned short vl_crc;

    //回复串口正常接收发送数据
    slave_rs485_usart_enable[ENUM_COMM_INDEX_COMM](ENUM_USART_RX_TX_ENABLE);
    sl_slave_usart_reenable_count[ENUM_COMM_INDEX_COMM] = 0;

    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[0] = slave_rs485_get_dev_addr();
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[1] = SLAVE_RS485_CMD_BYPASS;
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[2] = 2+data_len;
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[3] = 2;// 肯定是透传给电池的 
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[4] = slave_rs485_cmd_update_port;//PORT 
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_indx = 5;
    memcpy(&pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_indx], data, data_len);
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_indx += data_len;
...
static bool master_rs485_cmd_poll_cnf(st_hub_cmd *pl_hub_cmd);
...
{ENUM_M_CMD_POLL, master_rs485_cmd_poll_cnf},
{ENUM_M_CMD_GET_DEV_VERSION, master_rs485_cmd_get_dev_version_cnf},
{ENUM_M_CMD_UPDATE_START, master_rs485_cmd_update_start_cnf},
{ENUM_M_CMD_UPDATE_EXCHANGE, master_rs485_cmd_update_exchange_cnf},
{ENUM_M_CMD_UPDATE_DONE, master_rs485_cmd_update_done_cnf},
};

rs485_state_t master_rs485_state = MASTER_RS485_RESET;
...
bool master_rs485_data_handler_new_protocol(void)
{
        ...
        master_rs485_rx.rs485_rx_buf[(master_rs485_rx.rs485_rx_indx-1)]==((uint8_t)(0xFF&(crc>>8))))
    {
        ...
        //    return FALSE;
        //}
        vl_hub_cmd.stl_cmd = master_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_CMD+1];
        vl_hub_cmd.stl_dataL = master_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_DATAL+1];
        vl_hub_cmd.stl_data = &master_rs485_rx.rs485_rx_buf[HUM_FRAME_INDEX_DATA_START+1];
...
bool master_rs485_cmd_add(ENUM_MASTER_CMD master_cmd, unsigned char *data)
{
    unsigned char i;

    //在升级充电器过程中，不允许发送其他命令
    if(sl_master_state.normal_cmd_delay_when_chger_updating_cnt)
        return FALSE;
...
bool master_rs485_is_cmd_list_empty(void)
{
...
bool master_rs485_cmd_get_from_list(ENUM_MASTER_CMD *master_cmd, unsigned char **data)
{
...
bool master_rs485_one_cmd_delet_from_list(void)
{
    if(!list_empty(&master_rs485_head))
    {
        list_del_init(master_rs485_head.next);
        sl_master_state.cmd_snd_faild_cnt = 0; //单个命令发送失败计数清零
        return TRUE;
    }
    return FALSE;
}
...
void master_rs485_timer_cb(void)
{
    ...
    if(sl_master_state.cmd_timeout_cnt)
    {
        ...
        if(!sl_master_state.cmd_timeout_cnt)
        {
            ...
            sl_master_state.cmd_snd_faild_cnt++;
            sl_master_state.all_cmd_snd_faild_cnt++;
        }
    }

    //定时查询充电器
    if(sl_master_state.poll_charger_cmd_cnt)
    {
        sl_master_state.poll_charger_cmd_cnt--;
        if(!sl_master_state.poll_charger_cmd_cnt)
        {
            sl_master_state.poll_charger_cmd_cnt = 3000;//十秒查询一次

            #if 0
            //填发送数据
            gl_poll_cmd_param.chg_en = 0;
            gl_poll_cmd_param.expect_voltage[0] = 670&0xFF;
            gl_poll_cmd_param.expect_voltage[1] = (670>>8)&0xFF;
            gl_poll_cmd_param.expect_current[0] = (50)&0xFF;
            gl_poll_cmd_param.expect_current[1] = (50>>8)&0xFF;
            gl_poll_cmd_param.bat_temp = 0;
            gl_poll_cmd_param.rated_cap[0] = 100&0xFF;
            gl_poll_cmd_param.rated_cap[1] = (100>>8)&0xFF;
            gl_poll_cmd_param.rated_voltage[0] = 600&0xFF;
            gl_poll_cmd_param.rated_voltage[1] = (600>>8)&0xFF;
            
            memset(gl_poll_cmd_param.reserve, 0, 6);
            #endif
            //增加查询命令到命令发送的队列
            master_rs485_cmd_add(ENUM_M_CMD_POLL, (unsigned char *)&gl_poll_cmd_param);
            if(sl_master_chg_new_protocol)
                master_rs485_cmd_add(ENUM_M_CMD_GET_DEV_VERSION, (unsigned char *)&gl_poll_cmd_param);
            
        }
    }

    if(sl_master_state.ID_close_delay_cnt)
        sl_master_state.ID_close_delay_cnt--;

    if(sl_master_state.next_cmd_interval_cnt)
        sl_master_state.next_cmd_interval_cnt--;

    #ifdef CABINET_WARMOR_SUPPLY_BY_CHARGER
    master_rs485_is_charger_warmer_test_cb();
    #endif

    if(sl_master_state.normal_cmd_delay_when_chger_updating_cnt)
        sl_master_state.normal_cmd_delay_when_chger_updating_cnt--;

    if(sl_master_state.charger_com_err_report_delay_cnt)
        sl_master_state.charger_com_err_report_delay_cnt--;
...
void master_rs485_cmd_poll_process(void)
{
    ...
    if(sl_master_state.cmd_snd_faild_flag)
    {
        ...
        if(master_rs485_cmd_get_from_list(&master_cmd, &data))
        {
            switch(master_cmd)
            {
                case ENUM_M_CMD_POLL:
        ...
        //删除链表中的命令
        master_rs485_one_cmd_delet_from_list();
    ...
    if((sl_master_state.cmd_processing_flag == 0)&&
        (master_rs485_cmd_get_from_list(&master_cmd, &data))&&
        (0 == sl_master_state.next_cmd_interval_cnt))
    {
        ...
        switch(master_cmd)
        {
            case ENUM_M_CMD_POLL:
                //在链路上发送数据
                master_rs485_snd_cmd_poll(data);
                break;
            case ENUM_M_CMD_GET_DEV_VERSION:
                master_rs485_snd_cmd_get_dev_version(NULL);
                break;
            default:
                break;
        }
...
//////////////////////////////////////////////////////////////
    ...
    pl_data = &pl_rs485_tx[ENUM_COMM_INDEX_CHG]->rs485_tx_buf[0];
    
    vl_index = 0;
    pl_data[0] = 0x01;
    pl_data[1] = ENUM_M_CMD_POLL;
    ...
    pl_rs485_tx[ENUM_COMM_INDEX_CHG]->rs485_tx_indx = vl_index;
    slave_rs485_run_state[ENUM_COMM_INDEX_CHG]=MASTER_RS485_RUN_TX;
}
...
{
    char *pl_data;
    pl_data = (char *)&(pl_rs485_tx[ENUM_COMM_INDEX_CHG]->rs485_tx_buf[0]);
    
    strcpy(pl_data, "MCU Restart!");
    pl_rs485_tx[ENUM_COMM_INDEX_CHG]->rs485_tx_indx = 12;
    slave_rs485_run_state[ENUM_COMM_INDEX_CHG]=MASTER_RS485_RUN_TX;
}
...
//接收到正确的应答包，删除命令和重置变量
static void master_rs485_rcv_ack_process(void)
{
    //删除链表中的命令
    master_rs485_one_cmd_delet_from_list();
    sl_master_state.cmd_processing_flag = 0;
...
void master_rs485_snd_cmd_get_dev_version(unsigned char* data)
{
    ...
    vl_index = 0;
    pl_data[0] = 0x01;
    pl_data[1] = ENUM_M_CMD_GET_DEV_VERSION;
    pl_data[2] = 2;//数据长度
...
static bool master_rs485_cmd_poll_cnf(st_hub_cmd *pl_hub_cmd)
{
    st_poll_cmd_cnf_param *pl_poll_cmd_cnf_param;
    //处理返回的数据.
    pl_poll_cmd_cnf_param = (st_poll_cmd_cnf_param *)pl_hub_cmd->stl_data;
    //判断充电器中的充电设置是否跟我们要求的一致
    if((gl_poll_cmd_param.chg_en)
        //((gl_poll_cmd_param.expect_current[0]+(gl_poll_cmd_param.expect_current[1]<<8)) == pl_poll_cmd_cnf_param->chg_current)&&
        //((gl_poll_cmd_param.expect_voltage[0]+(gl_poll_cmd_param.expect_voltage[1]<<8)) == (pl_poll_cmd_cnf_param->chg_voltage[0]+(pl_poll_cmd_cnf_param->chg_voltage[0]<<8)))
        )
    {
        //一致，则通过ID设置充电器允许充电
//        main_charger_enable_by_id();
    }
    
    gl_poll_cmd_cnf_param = *pl_poll_cmd_cnf_param;
    if(pl_hub_cmd->stl_dataL < sizeof(st_poll_cmd_cnf_param))
    {
        unsigned char *vl_p;
        vl_p = (unsigned char*)&gl_poll_cmd_cnf_param;
        memset(&vl_p[pl_hub_cmd->stl_dataL], 0, (sizeof(st_poll_cmd_cnf_param) - pl_hub_cmd->stl_dataL));
    }

    //计算充电器到电池这条链路的内阻
    master_rs485_charger_resistance_check_process();

    #ifdef TEST_BAT_V_VIA_CHARGER_EN
    //当充电器有电流输出并且电池有电流输入时候，清除damage32(连接器未连接好)标志
    if(FALSE == Battery_check_bat_v_is_valid() 
        && (30050 <= Battery_get_TCurrent(0)) //电池电流需要大于500mA
        && ((5 <= gl_poll_cmd_cnf_param.chg_current[0]) || (gl_poll_cmd_cnf_param.chg_current[1]))//充电器电流大于500mA
        )
    {
        //
        gl_check_bat_v.bat_v_charger_charge_valid_cnt++;
        if(gl_check_bat_v.bat_v_charger_charge_valid_cnt >= 20)
        {
            Battery_check_bat_v_set_valid_flag();
        }
    }
    else
    {
        gl_check_bat_v.bat_v_charger_charge_valid_cnt = 0;
    }
    #endif

    #ifdef TEST_BAT_V_VIA_CHARGER_EN
    if(gl_check_bat_v.bat_v_charger_cmd_cnt)
    {
        gl_check_bat_v.bat_v_charger_cmd_cnt--;
    }
    #endif
    ...
    if(is_battery_voltage_OK(0))
    {
        ...
        vl_bat_current = Battery_get_reg_value(0, ENUM_REG_ADDR_TCURR);
        //if(vl_charger_current != 0)
        if(vl_bat_current != 0xFFFF)
        {
            //vl_bat_current = Battery_get_TCurrent(0);
            

            vl_charger_current *= 10;
            vl_charger_current += 30000;

            if(vl_charger_current > vl_bat_current) 
            {
                if(((vl_charger_current - vl_bat_current) >= CHARGER_CURR_BAT_CURR_DIFF_MAX)
                #ifdef CABINET_WARMOR_SUPPLY_BY_CHARGER
                &&(0 == master_rs485_get_charger_warmer_fsm_state()) //处于充电模式才判断该故障
                #endif
                )
                {
                    //if(0 == gl_event_to_stop_chg_param.current_diff_counter)
                    //{
                    //    gl_event_to_stop_chg_param.current_diff_counter = gl_delay_cnt_test;
                    //}
                    gl_event_to_stop_chg_param.current_diff_counter++;
                    //计数比较
                    //if((gl_delay_cnt_test - gl_event_to_stop_chg_param.current_diff_counter) >= 16000)//16秒
                    if(gl_event_to_stop_chg_param.current_diff_counter > 5)
                    {
                        #ifdef EVENT_TO_STOP_CHARGING_ENABLE
                        Battery_set_event_to_stop_chg_flag(ENUM_SCR_OF_STOP_FLAG_CURRENT_DIFF);
                        #endif
                    }
                }
                else
    ...
    master_rs485_charger_error_cycle_lock_process(gl_poll_cmd_cnf_param.charger_OAP_flag,
                                                gl_poll_cmd_cnf_param.bit5_reserv,
                                                gl_poll_cmd_cnf_param.charger_OVP_flag,
                                                gl_poll_cmd_cnf_param.charger_OTP_flag);

    // 充电器报告故障，存起来确保可以上传到上位机
    if(gl_poll_cmd_cnf_param.charger_OAP_flag ||
        gl_poll_cmd_cnf_param.charger_OVP_flag||
        gl_poll_cmd_cnf_param.charger_OTP_flag||
        gl_poll_cmd_cnf_param.charger_UAP_flag||
        ...
        gl_poll_cmd_cnf_param.charger_low_AC_supply_flag)
    {
        gl_charger_err_status.is_need_update = 1;
        //充电器状态1
        gl_charger_err_status.charger_err[0] = ((unsigned char*)&gl_poll_cmd_cnf_param)[6];
        //充电器状态2
        gl_charger_err_status.charger_err[1] = ((unsigned char*)&gl_poll_cmd_cnf_param)[7];
    }
...
{
    unsigned char *pl_data;
    unsigned char vl_data_index;

    unsigned short vl_crc;

    pl_data = &pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_buf[0];

    pl_rs485_rx[ENUM_COMM_INDEX_CHG]->rs485_rx_buf[0] = slave_rs485_get_dev_addr(); //PMS地址
    pl_rs485_rx[ENUM_COMM_INDEX_CHG]->rs485_rx_buf[4] = slave_rs485_cmd_update_port; //port口
    memcpy(pl_data, &pl_rs485_rx[ENUM_COMM_INDEX_CHG]->rs485_rx_buf[0], pl_rs485_rx[ENUM_COMM_INDEX_CHG]->rs485_rx_indx-2);
    vl_data_index = pl_rs485_rx[ENUM_COMM_INDEX_CHG]->rs485_rx_indx-2;
    vl_crc = slave_rs485_calc_CRC(pl_data, vl_data_index);
    //crc
    pl_data[vl_data_index++] = vl_crc&0xFF;
    pl_data[vl_data_index++] = (vl_crc>>8)&0xFF;
    pl_rs485_tx[ENUM_COMM_INDEX_COMM]->rs485_tx_indx = vl_data_index;
    //设置发送超时计数值，超时就不再发送数据
    slave_rs485_comm_TX_delay_cnt_max = SLAVE_RS485_COMM_TX_DELAY_CNT_MAX_LONG;
    slave_rs485_run_state[ENUM_COMM_INDEX_COMM]=MASTER_RS485_RUN_TX;    
...
void master_rs485_cmd_list_init(void)
{    
    unsigned char i;
    ...
    //初始化节点数据
    //memset((unsigned char*)master_cmd_normal_node, 0, sizeof(master_cmd_normal_node));
    for(i = 0; i < MASTER_CMD_NODE_MAX; i++)
    {
        INIT_LIST_HEAD(&master_cmd_normal_node[i].list);
    }
    //情况状态变量结构体
    memset(&sl_master_state, 0, sizeof(sl_master_state));
    sl_master_state.charger_com_err_report_delay_cnt = 10000;//10秒延迟

    #if 0
    // 2018-1-15 不再根据ID线是否插入的信号来判断是否需要485轮询充电器。现在强制间隔轮询
    
    //如果充电器插入，设置轮询时间间隔
    if(0 == GPIO_PinInGet(BATTERY_CHARGER_TEST_PORT, BATTERY_CHARGER_TEST_PIN))
        sl_master_state.poll_charger_cmd_cnt = 1000;
    else
        sl_master_state.poll_charger_cmd_cnt = 0;
    #else
    sl_master_state.poll_charger_cmd_cnt = 1000;
    #endif
    
    //充电器的设置参数初始化
    memset((unsigned char*)&gl_poll_cmd_param, 0, sizeof(st_poll_cmd_param));
    //初始化充电器允许的最大充电电流
    master_rs485_set_chg_current_max_value(MASTER_RS485_CHG_CURRENT_MAX_DEFAULT);
    //初始化充电器允许的最大充电电压
    master_rs485_set_chg_voltage_max_value(MASTER_RS485_CHG_VOLTAGE_MAX_DEFAULT);
    ...
    while(0)
    {
        st_master_cmd * pnode; 
        //
        list_add_tail(&master_cmd_normal_node[0].list,&master_rs485_head);     //添加节点
        //list_add_tail(&master_state_node[1].list,&master_rs485_head);     //添加节点
        //list_add_tail(&master_state_node[2].list,&master_rs485_head);     //添加节点
        //list_add_tail(&master_state_node[3].list,&master_rs485_head);     //添加节点

        list_for_each(plist,&master_rs485_head)//遍历链表，打印结果
        {
            pnode = list_entry(plist,struct struct_master_cmd,list);//然后取得数据项，因此一般来说和list_for_each配合使用
            //pnode->test = pnode->test+1;
        }

        if(!list_empty(&master_rs485_head))          //判断链表是否为空
        {
...
void slave_rs485_communication_init(enum_comm_index index)
{
    ...
    {
        //drv_usart0_init(usart0_tx_buf,BUFFERSIZE,usart0_rx_buf,BUFFERSIZE);
        slave_rs485_usart_enable[index] = drv_usart0_enable;
        sl_slave_usart_reenable_count[index] = 0;
        ...
        case MASTER_RS485_RUN://发送数据给中控，从中控接收数据并处理
            ...
            switch(slave_rs485_run_state[index])
            {
                ...
                case MASTER_RS485_RUN_TX:
                    ...
                    if((ENUM_COMM_INDEX_COMM == index)&&
                            (0 == slave_rs485_comm_TX_delay_cnt_max))
                    {
                        //处理数据包超时，不再发送数据
                    ...
                    if(NTAG_get_nfc_working_status())
                    {
                        //如果正在发送NFC则不发送串口数据
                        return ;
                    }
                    ...
                    #if 0
                    while(slave_rs485_put_byte[index](RS485_FRAME_HEAD) != APP_SUCCESS);
                    for (uint32_t i = 0; i < (pl_rs485_tx[index]->rs485_tx_indx); i++)
                    {
                        if(pl_rs485_tx[index]->rs485_tx_buf[i]==0x7e)
                        {
                            while(slave_rs485_put_byte[index](0x8c) != APP_SUCCESS);
                            while(slave_rs485_put_byte[index](0x81) != APP_SUCCESS);
                        }
                        else if(pl_rs485_tx[index]->rs485_tx_buf[i]==0xff)
                        {
                            while(slave_rs485_put_byte[index](0x8c) != APP_SUCCESS);
                            while(slave_rs485_put_byte[index](0x00) != APP_SUCCESS);
                        }
                        else if(pl_rs485_tx[index]->rs485_tx_buf[i]==0x8c)
                        {
                            while(slave_rs485_put_byte[index](0x8c) != APP_SUCCESS);
                            while(slave_rs485_put_byte[index](0x73) != APP_SUCCESS);
                        }
                        else
                        {
                            while(slave_rs485_put_byte[index](pl_rs485_tx[index]->rs485_tx_buf[i]) != APP_SUCCESS);
                        }
                    }
                    while(slave_rs485_put_byte[index](RS485_FRAME_TAIL) != APP_SUCCESS);
                    #else
                    {
                        unsigned char k;
                ...
                case MASTER_RS485_RUN_RX:                                        
                    ...
                    while(slave_rs485_get_byte[index](&data)==APP_SUCCESS)        
                    {
                        ...
                        //parse rs485 packet
                        //if((data==0x7e) && (pl_rs485_rx->rs485_rx_sta_tail==FALSE))
                        if(data==0x7e)                            
                        {
                        ...
                        else if((pl_rs485_rx[index]->rs485_rx_sta_head==TRUE) && (pl_rs485_rx[index]->rs485_rx_sta_tail==FALSE))
                        {
                            ...
                            {                                
                                ...
                                else if(data==0xff)
                                {
                                    ...
                                    if(index == ENUM_COMM_INDEX_COMM)
                                    {
                                        if(0 != slave_rs485_comm_TX_delay_cnt_max)
                                            vl_result = slave_rs485_data_handler_new_protocol();
                                        else
                                        {
                                            pl_rs485_rx[index]->rs485_rx_sta_head=FALSE;
                                            pl_rs485_rx[index]->rs485_rx_sta_tail=FALSE;
...
{
    master_rs485_communication(master_rs485_state);
    master_rs485_cmd_poll_process();
    /*Test*/
//    if(master_rs485_charger_test_process())
//    {
//        return;
//    }
}
...
//    /*初始硬件开关的状态*/
//    power_mode_set_mode(ENUM_POWER_MODE_CHARGE);
    
    //init param
    gl_rs485_param.usart_tx_flag = 0;
    gl_rs485_param.usart_config_param.baud_rate = BAUD_RATE_9600; /* 9600 bits/s */
    gl_rs485_param.usart_config_param.data_bits = DATA_BITS_8;      /* 8 databits */
	...
	master_rs485_state = MASTER_RS485_RESET;
    master_rs485_communication(master_rs485_state);
    master_rs485_state = MASTER_RS485_RUN;
